CREATE OR REPLACE FUNCTION config.f_get_table_setup_sript(_interval_unit TEXT, _interval_value TEXT)
    RETURNS text
    LANGUAGE plpgsql
AS
    $$
    DECLARE
        ...
        _complete_table_setup_script    TEXT := 'BEGIN;' || CHR(10) || CHR(10) ||
                                                _create_data_table_script || CHR(10) || CHR(10) ||
                                                ...
                                                _create_heiken_complete_data_view_script || CHR(10) || CHR(10) ||
                                                'COMMIT;';
